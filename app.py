...
if not df_sesi.empty:
  # Jika kolom sesi belum ada atau ada yang kosong/null, isi dengan default 'London Session'
  if "sesi" not in df_sesi.columns:
  ...
  st.dataframe(sesi_summary, use_container_width=True)
    # --- TAMBAHAN OTOMATIS SESI MARKET & REKAP ---
